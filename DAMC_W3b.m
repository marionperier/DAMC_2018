...
for i = 1:outer_folds
    ...
    for j = 1:inner_folds
        ...
        for N_sel = 1:80
            ...
            classifier = fitcdiscr(train_data_sel, inner_train_labels, 'discrimtype', 'linear');
    ...
    mean_error = mean(error,1); %mean error for each N of feature used
    ...
    best_classifier = fitcdiscr(best_train_data, outer_train_labels, 'discrimtype', 'linear');
